...
go_home_right_helper() {
    # This is for putting the robot in the walking home position
    echo "ctpq time $1 off 0 pos (-34 30.0 0.0 50.0 0.0 0.0 0.0 15.0 64.0 0.0 0.0 0.0 20.0 0.0 0.0 0.0)" | yarp rpc /ctpservice/right_arm/rpc
}    

go_home_right() {
    sleep 1.0
    go_home_right_helper 2.0
}

go_home_left_helper() {
    # This is for putting the robot in the walking home position
    echo "ctpq time $1 off 0 pos (-34 30.0 0.0 50.0 0.0 0.0 0.0 15.0 64.0 0.0 0.0 0.0 20.0 0.0 0.0 0.0)" | yarp rpc /ctpservice/left_arm/rpc
}    

go_home_left() {
    sleep 1.0
    go_home_left_helper 2.0
}

go_home_both_hands_helper() {
    echo "ctpq time $1 off 0 pos (-34 30.0 0.0 50.0 0.0 0.0 0.0 15.0 64.0 0.0 0.0 0.0 20.0 0.0 0.0 0.0)" | yarp rpc /ctpservice/right_arm/rpc
    echo "ctpq time $1 off 0 pos (-34 30.0 0.0 50.0 0.0 0.0 0.0 15.0 64.0 0.0 0.0 0.0 20.0 0.0 0.0 0.0)" | yarp rpc /ctpservice/left_arm/rpc
}
